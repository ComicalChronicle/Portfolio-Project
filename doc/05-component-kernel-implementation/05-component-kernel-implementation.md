...
I am going to use NaturalNumber because it is a good choice for representing
non-negative integers, like health, as it already enforces non-negative values.
